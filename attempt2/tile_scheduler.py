...
class SimpleTileScheduler:
    ...
    def create(params: Params, *, loc=None, ip=None) -> "SimpleTileScheduler":
        ...
        batch_idx = Int32(bidz)

        cidx, cidy, _ = cute.arch.cluster_idx()
        cdimx, cdimy, _ = cute.arch.cluster_dim()
        cluster_id = cidx + cidy * cdimx # TODO this may be wrong
        # if params.raster_order == RasterOrder.AlongN:
        #     cluster_id = cidx * cdimy + cidy
        return SimpleTileScheduler(Int32(cluster_id), batch_idx, Int32(0), params, loc=loc, ip=ip)

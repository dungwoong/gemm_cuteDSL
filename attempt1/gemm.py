...
THREADS_PER_WG = 128 # TODO hopefully putting this outside of the class won't cause any problems...
...
class GemmSM90:
    def __init__(
        ...
        # Kernel config
        # No staged epilogue for now, I'll figure it out later
        self.occupancy = 1
        self.mma_warpgroups = math.prod(self.atom_layout_mnk)
        assert self.mma_warpgroups in [1, 2, 3] # that's all we can afford
